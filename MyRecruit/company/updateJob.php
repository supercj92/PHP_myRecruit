            ...
            ?>
            	...
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	...
                    	<form action="../controller/jobsProcess.php" method="post" id="jobForm">
                            ...
                            <table class="btm">
                            	...
                            	<td width="25"><span class="redstar">*</span></td>
                                	<td width="85">公司名称</td>
                                	<td>
                                	<input type="text" name="companyName" value="<?php echo $arr[0]['companyname'] ?>">
                                	</td>
                            	</tr>
                            	<tr>
                                	<td width="25"><span class="redstar">*</span></td>
                                	<td width="85">职位类别</td>
                                	<td>
                                    	<input type="hidden" id="positionType" value="<?php echo  $arr[0]['positionType']?>" name="positionType">
                                        <input type="button" value="<?php echo  $arr[0]['positionType']?>" id="select_category" class="selectr selectr_380">                                      
                            	...
                            	<tr>
                                	...
                                	<td>职位名称</td>
                                	<td>
                                    	<input type="text" placeholder="" value="<?php echo $arr[0]['positionName'] ?>" name="positionName" id="positionName">
                                    	                                    </td>
                                </tr>
                            	<tr>
                                	<td></td>
                                	<td>所属部门</td>
                                	<td>
                                    	<input type="text" placeholder="" value="<?php echo $arr[0]['department'] ?>" name="department" id="department">	
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	...
                            	<tr>
                                	...
                                	<td>
                                    	<div class="salary_range">
                                            <div>
                                                <input type="text" placeholder="" value="<?php echo $arr[0]['salaryMin'] ?>" id="salaryMin" name="salaryMin"> 
                                                <span>k</span>
                                            </div>
                                            <div>
                                                <input type="text" placeholder="" value="<?php echo $arr[0]['salaryMax'] ?>" id="salaryMax" name="salaryMax"> 
                                                <span>k</span>
                                            </div>
                            	...
                            	<tr>
                                	...
                                	<td>工作城市</td>
                                	<td>
                                    	<input type="text" placeholder="" value="<?php echo $arr[0]['workAddress'] ?>" name="workAddress" id="workAddress">
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">工作经验</td>
                                	<td>
                                    	<input type="hidden" id="experience" value="<?php echo $arr[0]['workYear'] ?>" name="workYear">
                                        <input type="button" value="<?php echo $arr[0]['workYear'] ?>" id="select_experience" class="selectr selectr_380">                                      
                            	...
                            	<tr>
                                    ...
                                    <!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> -->
                                	<td>
                                    	<input type="hidden" id="education" value="<?php echo $arr[0]['education'] ?>" name="education">
                                        <input type="button" value="<?php echo $arr[0]['education'] ?>" id="select_education" class="selectr selectr_380">                                      
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">职位诱惑</td>
                                	<td>
                                    	<input type="text" placeholder="" value="<?php echo $arr[0]['positionAdvantage'] ?>" name="positionAdvantage" class="input_520" id="positionAdvantage">
                                    </td>
                                </tr>
                            	<tr>
                                	<td><span class="redstar">*</span></td>
                                ...
                                <tr>
                                	...
                                	<td>工作地址</td>
                                	<td>
                                    	<input type="text" placeholder="" value="<?php echo $arr[0]['positionAddress'] ?>" name="positionAddress" class="input_520" id="positionAddress">	
                            ...
                            <table>
                                ...
                                <tr>
                                	...
                                	<td colspan="2">
                                    	同时简历自动发送至邮箱（仅一个）
                                        <input type="text" value="<?php echo $arr[0]['forwardEmail'] ?>" id="forwardEmail" name="forwardEmail">
                                ...
                                <tr>
                                    ...
                                    <input type="submit" value="更&nbsp;&nbsp;新" class="btn_32">
                                    </td>
                                </tr>
                         	</tbody></table>
                        </form>
