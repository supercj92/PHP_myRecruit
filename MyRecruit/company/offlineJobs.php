	...
	$arr=$jobs->getInvalidJobs();
	$num=count($arr);
	?>
                            
                           已经下线职位 <span>（共<i style="color:#fff;font-style:normal" id="positionNumber"><?php echo $num ?></i>个）</span>                        </h1>
                    </dt>
                    <dd>
                    		                    	<form id="searchForm">
		                                    ...
		                                    <h3>
		                                      ...
		                                      <a>  $companyname</a>
		                                        <span>$workAddress</span>
		                                       	...
		                                       	<a  class='job_del' href='../controller/jobsProcess.php?flag=offline&job_id=$job_id&isValid=1'>上线</a>                      
