	...
	?>
                           ...
                           我投过的工作 <span>（共<i style="color:#fff;font-style:normal" id="positionNumber"><?php echo $num ?></i>个）</span>                        </h1>
                    </dt>
                    <dd>
                    		                    	<form id="searchForm">
	...
	for($i=0;$i<count($arr);$i++){
		...
		$positionName=$arrIt['positionName'];
		echo	"<li data-id='149594'>
		                                    <h3>
							
		                                      <a href='/myrecruit/controller/jobDetailPro.php?jobid={$job_id}'> $positionName </a>
		                                        ...
		                                        <a class='job_del' href='/myrecruit/controller/removeList.php?listid=6'>删除</a>
		                                    </div>
		                                    		                                </li>";
