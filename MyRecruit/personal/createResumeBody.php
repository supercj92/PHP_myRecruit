            ...
            <form action="../controller/resumeProcess.php" method="post">
            	<div class="fl" id="resume_name">
            		...
            		<div style="display: block" class="fl dn" id="resumeNameForm">
            			<input type="text" placeholder="输入简历名称" value="" name="resumeName" class="nameEdit c9">	
...
<!-- 						            		</div> -->
            <!-- 	</div> --><!--end #resumeScore-->
            			...
            			<div id="profileForm" >
						  <table>
						    <tbody><tr>
						      ...
						      <td>
						        <input type="text" placeholder="请输入姓名" value="" name="name" id="name">
						      </td>
						      <td valign="top"></td> 
						      <td>
						    ...
						    <tr>
						      ...
						      <td colspan="3">
						          ...
						          <input type="button" placeholder="目前状态" value="目前状态" id="select_currentState" class="profile_select_410 profile_select_normal">
				...
				<input type="submit" value="创建简历" class="btn_profile_save" >
				 </form>
            </div><!--end .content_l-->
